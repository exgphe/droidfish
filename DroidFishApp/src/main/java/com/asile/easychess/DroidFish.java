...
import com.asile.easychess.activities.EditPGNLoad;
import com.asile.easychess.activities.EditPGNSave;
import com.asile.easychess.activities.LoadFEN;
import com.asile.easychess.activities.LoadScid;
...
import com.asile.easychess.book.BookOptions;
import com.asile.easychess.engine.DroidComputerPlayer.EloData;
import com.asile.easychess.engine.EngineUtil;
import com.asile.easychess.engine.UCIOptions;
import com.asile.easychess.gamelogic.DroidChessController;
import com.asile.easychess.gamelogic.ChessParseError;
import com.asile.easychess.gamelogic.Game;
...
import com.asile.easychess.gamelogic.GameTree.Node;
import com.asile.easychess.gamelogic.TimeControlData;
import com.asile.easychess.tb.Probe;
import com.asile.easychess.tb.ProbeResult;
...
public class DroidFish extends Activity
...

        {
            ...
            addAction(new UIAction() {
                ...
                public void run() {
                    ...
                    if (currFT == FT_PGN) {
                        ...
                        i.setAction("com.asile.easychess.loadFilePrevGame");
                        i.putExtra("com.asile.easychess.pathname", currPathName);
                        startActivityForResult(i, RESULT_LOAD_PGN);
                    } else if (currFT == FT_SCID) {
                        i = new Intent(DroidFish.this, LoadScid.class);
                        i.setAction("com.asile.easychess.loadScidPrevGame");
                        i.putExtra("com.asile.easychess.pathname", currPathName);
                        startActivityForResult(i, RESULT_LOAD_PGN);
                    } else if (currFT == FT_FEN) {
                        i = new Intent(DroidFish.this, LoadFEN.class);
                        i.setAction("com.asile.easychess.loadPrevFen");
                        i.putExtra("com.asile.easychess.pathname", currPathName);
            ...
            addAction(new UIAction() {
                ...
                public void run() {
                    ...
                    if (currFT == FT_PGN) {
                        i = new Intent(DroidFish.this, EditPGNLoad.class);
                        i.setAction("com.asile.easychess.loadFileNextGame");
                        i.putExtra("com.asile.easychess.pathname", currPathName);
                        startActivityForResult(i, RESULT_LOAD_PGN);
                    } else if (currFT == FT_SCID) {
                        i = new Intent(DroidFish.this, LoadScid.class);
                        i.setAction("com.asile.easychess.loadScidNextGame");
                        i.putExtra("com.asile.easychess.pathname", currPathName);
                        startActivityForResult(i, RESULT_LOAD_PGN);
                    } else if (currFT == FT_FEN) {
                        i = new Intent(DroidFish.this, LoadFEN.class);
                        i.setAction("com.asile.easychess.loadNextFen");
                        i.putExtra("com.asile.easychess.pathname", currPathName);
                        startActivityForResult(i, RESULT_LOAD_FEN);
                    }
                }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        case RESULT_SAVE_PGN:
            if (resultCode == RESULT_OK) {
                long hash = data.getLongExtra("com.asile.easychess.treeHash", -1);
        ...
        case RESULT_SELECT_SCID:
            if (resultCode == RESULT_OK) {
                ...
                if (pathName != null) {
                    ...
                    i.setAction("com.asile.easychess.loadScid");
                    i.putExtra("com.asile.easychess.pathname", pathName);
                    startActivityForResult(i, RESULT_LOAD_PGN);
                }
            }
            break;
        ...
        case RESULT_EDITOPTIONS:
            if (resultCode == RESULT_OK) {
                ...
                Map<String,String> uciOpts =
                    (Map<String,String>)data.getSerializableExtra("com.asile.easychess.ucioptions");
    ...
    private void shareGameOrText(boolean game) {
        ...
        if (pgn.length() < 32768) {
            ...
            String authority = "com.asile.easychess.fileprovider";
    ...
    private Dialog aboutDialog() {
        ...
        try {
            PackageInfo pi = getPackageManager().getPackageInfo("com.asile.easychess", 0);
    ...
    private void setEngineOptions() {
        ...
        UCIOptions uciOpts = ctrl.getUCIOptions();
        if (uciOpts != null) {
            i.putExtra("com.asile.easychess.ucioptions", uciOpts);
            i.putExtra("com.asile.easychess.enginename", engineTitleText.getText());
            i.putExtra("com.asile.easychess.workDir", engineOptions.workDir);
            boolean localEngine = engineOptions.networkID.isEmpty();
            i.putExtra("com.asile.easychess.localEngine", localEngine);
    ...
    private void savePGNToFile(String pathName) {
        ...
        i.setAction("com.asile.easychess.saveFile");
        i.putExtra("com.asile.easychess.pathname", pathName);
        i.putExtra("com.asile.easychess.pgn", pgnToken);
    ...
    private void setEditPGNBackup(Intent i, String pathName) {
        ...
        i.putExtra("com.asile.easychess.backup", backup);
    }
    ...
    private void loadPGNFromFile(String pathName, boolean updateCurrFile) {
        ...
        i.setAction("com.asile.easychess.loadFile");
        i.putExtra("com.asile.easychess.pathname", pathName);
        i.putExtra("com.asile.easychess.updateDefFilePos", updateCurrFile);
        setEditPGNBackup(i, pathName);
        startActivityForResult(i, RESULT_LOAD_PGN);
    }
    ...
    private void loadFENFromFile(String pathName) {
        ...
        i.setAction("com.asile.easychess.loadFen");
        i.putExtra("com.asile.easychess.pathname", pathName);
        startActivityForResult(i, RESULT_LOAD_FEN);
    }
