...
public class LoadFEN extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ("com.asile.easychess.loadFen".equals(action)) {
            ...
            workThread.start();
        } else if ("com.asile.easychess.loadNextFen".equals(action) ||
                   "com.asile.easychess.loadPrevFen".equals(action)) {
            fenFile = new FENFile(fileName);
            boolean next = action.equals("com.asile.easychess.loadNextFen");
