...
public class LoadScid extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fileName = i.getStringExtra("com.asile.easychess.pathname");
        resultSentBack = false;
        canceled = false;
        if ("com.asile.easychess.loadScid".equals(action)) {
        ...
        } else if ("com.asile.easychess.loadScidNextGame".equals(action) ||
                   "com.asile.easychess.loadScidPrevGame".equals(action)) {
            boolean next = action.equals("com.asile.easychess.loadScidNextGame");
