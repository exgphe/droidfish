...
public class EditOptions extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        uciOpts = (UCIOptions) i.getSerializableExtra("com.asile.easychess.ucioptions");
        engineName = (String) i.getSerializableExtra("com.asile.easychess.enginename");
        workDir = (String) i.getSerializableExtra("com.asile.easychess.workDir");
        hasBrowser = (Boolean) i.getSerializableExtra("com.asile.easychess.localEngine");
        if (uciOpts != null) {
            if (hasBrowser)
    ...
    private void sendBackResult() {
        if (uciOpts != null) {
            ...
            Intent i = new Intent();
            i.putExtra("com.asile.easychess.ucioptions", uciMap);
